...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        image = sprite_sheet.get_image(256, 0, 256, 256)
        self.walking_frames_r.append(image)
        image = sprite_sheet.get_image(512, 0, 256, 256)
        self.walking_frames_r.append(image)
        image = sprite_sheet.get_image(768, 0, 256, 256)
        self.walking_frames_r.append(image)
        image = sprite_sheet.get_image(1024, 0, 256, 256)
        self.walking_frames_r.append(image)
        image = sprite_sheet.get_image(1280, 0, 256, 256)
        self.walking_frames_r.append(image)
